...
########################################################################################################################################################################
	...
	for item in list26:
		...
		for item1 in list1:
			...
			elif flag in [(82,6,65,0),(60,6,65,0),(36,6,65,0),(10,6,65,0),(15,6,65,0),(8,6,65,0),(54,6,65,0),(38,6,65,0),(18,6,65,0),(22,6,65,0),(32,6,65,0),(50,6,65,0),(55,6,65,0),(48,6,65,0)]:#material
				type2=prp_reader.read_uint8(1)[0]
				list2=get_list(type2,prp_reader)
				material=Mat()
